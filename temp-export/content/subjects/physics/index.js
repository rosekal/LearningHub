...
exports.physicsAccentSources = exports.physicsUnits = exports.physicsTopics = exports.physicsSubject = void 0;
...
const topics = [
    {
        ...
        description: 'Core ideas of measurement, models, forces, energy, and the role of mathematics in describing physical systems.',
        units: [
    ...
    },
    {
        ...
        description: 'How forces affect motion, including Newtonian mechanics and the analysis of interacting bodies.',
        units: [
    ...
    },
    {
        ...
        description: 'Energy transfer, conservation laws, and the quantitative analysis of mechanical systems.',
        units: [
            { title: 'Work' },
    ...
    },
    {
        ...
        description: 'Momentum, impulse, and the behavior of colliding objects in isolated and non-isolated systems.',
        units: [
    ...
    },
    {
        ...
        description: 'Rotational kinematics, torque, angular momentum, and the gravitational interaction between masses.',
        units: [
    ...
    },
    {
        ...
        description: 'Periodic motion, wave behavior, sound, and the transfer of energy through oscillating systems.',
        units: [
    ...
    },
    {
        ...
        description: 'Heat, temperature, energy transfer, and the laws governing thermal systems.',
        units: [
    ...
    },
    {
        ...
        description: 'Charge, electric fields, potential, current, resistance, and basic circuit behavior.',
        units: [
    ...
    },
    {
        ...
        description: 'Magnetic fields, electromagnetic induction, and the connection between electricity and magnetism.',
        units: [
    ...
    },
    {
        id: 'optics',
        title: 'Optics',
        description: 'The behavior of light, image formation, and wave and ray models of optical phenomena.',
        units: [
    ...
    },
    {
        ...
        description: 'Relativity, quantum ideas, atomic and nuclear physics, and foundational twentieth-century physical theory.',
        units: [
...
const built = (0, createStructuredSubject_1.createStructuredSubject)({
    id: 'physics',
    title: 'Physics',
    description: 'Local-first physics content spanning motion, forces, energy, fields, waves, thermal systems, optics, and modern physics.',
...
exports.physicsSubject = built.subject;
exports.physicsTopics = built.topics;
exports.physicsUnits = built.units;
exports.physicsAccentSources = built.accentSources;
