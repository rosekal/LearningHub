...
exports.oceanographyAccentSources = exports.oceanographyUnits = exports.oceanographyTopics = exports.oceanographySubject = void 0;
...
const topics = [
    {
        ...
        description: 'Core concepts, history, methods, and systems-level understanding of the oceans as physical, chemical, biological, and geological environments.',
    ...
    },
    {
        ...
        description: 'The structure of ocean basins, seafloor features, sediments, and tectonic processes beneath the oceans.',
        units: (0, createStructuredSubject_1.structuredUnits)([
    ...
    },
    {
        ...
        description: 'The motion, properties, and circulation of seawater across local and global scales.',
        units: (0, createStructuredSubject_1.structuredUnits)([
    ...
    },
    {
        ...
        description: 'The chemical composition of seawater, dissolved gases, nutrient cycles, and chemical exchange processes.',
        units: (0, createStructuredSubject_1.structuredUnits)([
    ...
    },
    {
        ...
        description: 'Marine life, ocean ecosystems, food webs, productivity, and biological adaptation to marine environments.',
        units: (0, createStructuredSubject_1.structuredUnits)([
            'Life in the Ocean',
    ...
    },
    {
        ...
        description: 'Dynamic coastal environments where land, ocean, and atmosphere interact.',
        units: (0, createStructuredSubject_1.structuredUnits)([
    ...
    },
    {
        ...
        description: 'Marine resources, pollution, climate impacts, fisheries, and stewardship of ocean environments.',
        units: (0, createStructuredSubject_1.structuredUnits)([
...
const built = (0, createStructuredSubject_1.createStructuredSubject)({
    id: 'oceanography',
    title: 'Oceanography',
    description: 'Local-first oceanography content spanning marine systems, seafloor structure, circulation, chemistry, ecosystems, coasts, and human-ocean interaction.',
...
exports.oceanographySubject = built.subject;
exports.oceanographyTopics = built.topics;
exports.oceanographyUnits = built.units;
exports.oceanographyAccentSources = built.accentSources;
