...
exports.chemistryElementSeeds = void 0;
const additionalElementSeeds_1 = require("@/content/subjects/chemistry/additionalElementSeeds");
const actinideElementSeeds_1 = require("@/content/subjects/chemistry/actinideElementSeeds");
const earlyPeriodSixElementSeeds_1 = require("@/content/subjects/chemistry/earlyPeriodSixElementSeeds");
const latePeriodFiveElementSeeds_1 = require("@/content/subjects/chemistry/latePeriodFiveElementSeeds");
const latePeriodSixElementSeeds_1 = require("@/content/subjects/chemistry/latePeriodSixElementSeeds");
const latePeriodSixHeavyElementSeeds_1 = require("@/content/subjects/chemistry/latePeriodSixHeavyElementSeeds");
const midPeriodicElementSeeds_1 = require("@/content/subjects/chemistry/midPeriodicElementSeeds");
const postZincElementSeeds_1 = require("@/content/subjects/chemistry/postZincElementSeeds");
const superheavyElementSeeds_1 = require("@/content/subjects/chemistry/superheavyElementSeeds");
const transitionElementSeeds_1 = require("@/content/subjects/chemistry/transitionElementSeeds");
...
exports.chemistryElementSeeds = [
    {
        ...
        oxidationStates: '+1, -1',
        summaryLine: 'Hydrogen is the lightest element and a chemically unusual nonmetal whose single electron links acid-base chemistry, redox chemistry, isotopes, and energy systems.',
        importanceLine: 'Its chemistry connects the periodic table to molecular bonding, nuclear science, industrial synthesis, and modern energy technology.',
        heroFacts: [
        ...
        sections: {
            classification: section('Hydrogen is placed at the top of the periodic table as the simplest atom, but its chemistry does not fit neatly into any single family.', [
            ...
            electronic: section('The single 1s electron gives hydrogen the simplest possible valence pattern, yet that simplicity supports exceptionally rich chemistry.', [
            ...
            physical: section('Elemental hydrogen is encountered as a very light diatomic gas, and many of its most important physical features follow from weak intermolecular forces between small H2 molecules.', [
            ...
            reactivity: section('Hydrogen can appear deceptively gentle in the gas cylinder, but it becomes chemically decisive whenever strong X-H or O-H bond formation, catalytic activation, or proton transfer is involved.', [
            ...
            occurrence: section('Hydrogen is the most abundant element in the universe, yet on Earth it is mostly locked into compounds rather than encountered as free elemental gas.', [
            ...
            isotopes: section('No other light element demonstrates isotope effects as clearly as hydrogen, because the relative mass differences between protium, deuterium, and tritium are so large.', [
            ...
            production: section('Hydrogen production sits at the intersection of fuel processing, industrial catalysis, and low-carbon energy strategy.', [
            ...
            applied: section('Hydrogen matters technologically because it is both a reagent and an energy carrier, and intellectually because it helped shape central ideas of chemistry and physics.', [
    ...
    },
    {
        ...
        oxidationStates: '0',
        summaryLine: 'Helium is a closed-shell noble gas whose extraordinary physical properties make it far more important in cryogenics and measurement than its chemical reactivity would suggest.',
        importanceLine: 'It links atomic structure to low-temperature physics, natural-gas recovery, spectroscopy, and strategic resource management.',
        heroFacts: [
            'Filled 1s shell',
        ...
        sections: {
            classification: section('Helium is chemically interpreted through its completely filled 1s shell, which overrides the fact that it occupies period 1 rather than the higher-shell valence pattern seen in other noble gases.', [
            ...
            electronic: section('Helium shows how profoundly a closed-shell electron arrangement can suppress ordinary bond formation.', [
            ...
            physical: section('The scientific importance of helium comes far more from its physical behavior than from ordinary chemistry.', [
            ...
            reactivity: section('Helium is the classic example of an element whose practical hazards are usually physical rather than chemical.', [
            ...
            occurrence: section('Helium is cosmically abundant but geologically scarce, making its earthly supply a resource question as much as a scientific one.', [
            ...
            isotopes: section('Helium isotopes are disproportionately important in physics because small mass changes produce large quantum and thermodynamic consequences at very low temperature.', [
            ...
            production: section('Helium supply is an exercise in separation engineering rather than chemical synthesis.', [
            ...
            applied: section('Helium’s major uses arise from the combination of inertness, low density, and unmatched cryogenic behavior.', [
    ...
    },
    {
        ...
        oxidationStates: '+1',
        summaryLine: 'Lithium is the lightest metal, an alkali element with unusually small ionic size, distinctive bonding behavior, and outsized importance in electrochemical technology.',
        importanceLine: 'Its chemistry spans periodic trends, strong solvation effects, ore processing, batteries, and high-reactivity laboratory reagents.',
        ...
        sections: {
            classification: section('Lithium belongs to the alkali metals, but its small size makes it behave differently from the heavier members of the group in many measurable ways.', [
            ...
            electronic: section('Lithium illustrates how a simple one-electron valence shell can still generate rich chemistry once ionic size and solvation are taken seriously.', [
            ...
            physical: section('Lithium is a metal, but many of its physical properties are unusual because the atoms are both light and relatively small.', [
            ...
            reactivity: section('Lithium is an alkali metal, yet its reactivity profile is more controlled and chemically nuanced than the dramatic demonstrations often associated with sodium or potassium.', [
            ...
            occurrence: section('Lithium never occurs native in nature, so its supply depends on the geochemistry of soluble salts and specialized silicate minerals.', [
            ...
            isotopes: section('Lithium isotope chemistry matters not because lithium is radioactive in ordinary samples, but because the two stable nuclides differ in abundance and nuclear usefulness.', [
            ...
            production: section('Lithium production begins not with metal but with salts, concentrates, and refining routes tuned to downstream battery requirements.', [
            ...
            applied: section('Lithium became globally important long before portable electronics, but modern batteries made it one of the signature elements of contemporary materials chemistry.', [
    ...
    },
    {
        ...
        oxidationStates: '+2',
        summaryLine: 'Beryllium is a light, stiff alkaline earth metal whose very small doubly charged ion makes its chemistry far more covalent and hazardous than group trends alone would suggest.',
        importanceLine: 'It connects periodic structure to polarizing power, oxide passivation, specialized metallurgy, and significant occupational toxicology.',
        ...
        sections: {
            classification: section('Beryllium is formally an alkaline earth metal, but its group identity must always be read alongside its unusually small cation and strong polarizing power.', [
            ...
            electronic: section('Beryllium demonstrates that a formally simple 2s2 valence shell can produce unexpectedly complex bonding once ionic size and electron deficiency are considered.', [
            ...
            physical: section('The physical appeal of beryllium lies in a combination of low density, rigidity, and transparency to X-rays that few other engineering elements can match.', [
            ...
            reactivity: section('Beryllium can seem less reactive than might be expected for an alkaline earth metal because a passive oxide film moderates the behavior of the surface.', [
            ...
            occurrence: section('Beryllium is not abundant, and economic production depends on a narrow set of mineral sources.', [
            ...
            isotopes: section('Beryllium isotope chemistry is unusual because one stable nuclide coexists with cosmogenic radioisotopes of major scientific value.', [
            ...
            production: section('Producing beryllium is a multi-step chemical purification problem constrained by both ore chemistry and stringent safety requirements.', [
            ...
            applied: section('Beryllium is important precisely because a small quantity of material can deliver exceptional mechanical or nuclear performance.', [
    ...
    },
    {
        ...
        oxidationStates: '+3',
        summaryLine: 'Boron is a metalloid whose electron deficiency, covalent networking, and unusual cluster chemistry make it one of the most conceptually distinctive light elements.',
        importanceLine: 'Its chemistry ties together multicenter bonding, borate minerals, nuclear technology, glass science, and semiconductor doping.',
        ...
        sections: {
            classification: section('Boron occupies the borderland between metals and nonmetals, but its chemistry is far more covalent than a simple intermediate label might suggest.', [
            ...
            electronic: section('Boron chemistry is shaped by the fact that three valence electrons are often not enough to satisfy ordinary two-center bonding expectations.', [
            ...
            physical: section('Elemental boron does not behave like a simple metal or a simple molecular solid; instead it forms hard, complex covalent structures.', [
            ...
            reactivity: section('Boron is relatively unreactive in bulk at room temperature, but that statement changes quickly once temperature, particle size, or compound class is altered.', [
            ...
            occurrence: section('Boron is not a major crustal element, yet local concentration into borate minerals makes it industrially accessible.', [
            ...
            isotopes: section('Boron is an excellent example of an element whose isotope chemistry matters both analytically and technologically.', [
            ...
            production: section('Industrial boron manufacture depends on converting abundant borate minerals into purified oxides, acids, or elemental material.', [
            ...
            applied: section('Boron’s applications are unusually diverse because the element can contribute hardness, neutron absorption, chemical durability, and electronic control depending on the compound.', [
    ...
    },
    {
        ...
        summaryLine: 'Carbon is a period-2 nonmetal whose ability to catenate and hybridize makes it the structural core of organic chemistry, major industrial materials, and the global carbon cycle.',
        importanceLine: 'Its chemistry links allotropy, bonding theory, combustion, climate science, metallurgy, and the molecular basis of life.',
        ...
        sections: {
            classification: section('Carbon sits at the boundary between simple elemental chemistry and the enormous structural diversity of organic compounds because four valence electrons allow many stable bonding patterns.', [
            ...
            electronic: section('Carbon’s electronic importance lies in the flexibility of four valence electrons, which can produce tetrahedral, trigonal, linear, aromatic, and extended-network bonding patterns.', [
            ...
            physical: section('Carbon has no single representative physical form; its allotropes differ so strongly that they seem almost like different materials rather than versions of one element.', [
            ...
            reactivity: section('Carbon is simultaneously stable enough to build durable frameworks and reactive enough to participate in combustion, redox chemistry, and an enormous range of synthesis.', [
            ...
            occurrence: section('Carbon is distributed through the atmosphere, hydrosphere, lithosphere, and biosphere in a way that makes it central to both geochemistry and life.', [
            ...
            isotopes: section('Carbon isotopes are famous because they are useful simultaneously in structural chemistry, Earth science, and archaeology.', [
            ...
            production: section('Industrial carbon processing is less about isolating elemental carbon from a single ore and more about controlling structure, purity, and feedstock transformation.', [
            ...
            applied: section('Carbon is applied at nearly every scale of chemistry, from the molecules of living cells to massive industrial furnaces and climate systems.', [
    ...
    },
    {
        ...
        summaryLine: 'Nitrogen is a pnictogen whose elemental stability as N2 contrasts with the extreme chemical importance of its fixed compounds in biology, agriculture, and atmospheric chemistry.',
        importanceLine: 'It connects triple-bonded diatomic molecules to fertilizers, explosives, atmospheric pollution, cryogenics, and the global nitrogen cycle.',
        ...
        sections: {
            classification: section('Nitrogen is classified as a period-2 pnictogen, but the physical and chemical identity of elemental nitrogen is dominated by the unusual strength of the N≡N bond.', [
            ...
            electronic: section('Nitrogen’s valence shell allows three ordinary covalent bonds, a lone pair, and one of the strongest multiple bonds seen in elemental molecules.', [
            ...
            physical: section('Nitrogen is physically familiar because it is the dominant gas in air, yet its significance in the laboratory often comes through the cryogenic properties of liquid nitrogen.', [
            ...
            reactivity: section('Nitrogen teaches a classic chemistry lesson: kinetic inertness of the element does not imply low reactivity across the rest of the element’s compounds.', [
            ...
            occurrence: section('Nitrogen is abundant in the atmosphere, but biological availability depends on conversion into chemically accessible forms.', [
            ...
            isotopes: section('Nitrogen isotopes are less famous to the public than carbon isotopes, but they are powerful tools in ecology, biochemistry, and atmospheric science.', [
            ...
            production: section('Nitrogen production is largely a separation problem, since the atmosphere already supplies a vast feedstock.', [
            ...
            applied: section('Nitrogen becomes technologically indispensable not because N2 itself is very reactive, but because controlled nitrogen chemistry supports agriculture, manufacturing, and cryogenic practice.', [
    ...
    },
    {
        ...
        summaryLine: 'Oxygen is a strongly electronegative chalcogen whose bonding power shapes minerals, water, respiration, combustion, and the chemistry of the atmosphere.',
        importanceLine: 'It joins atomic structure to oxidation, environmental cycles, steelmaking, medicine, and the historical foundations of modern chemistry.',
        ...
        sections: {
            classification: section('Oxygen occupies the top of group 16, and its strong electronegativity makes it the archetypal nonmetallic partner in countless compounds.', [
            ...
            electronic: section('Oxygen’s six-valence-electron configuration makes it strongly inclined to complete the octet by forming polarized bonds or accepting electron density.', [
            ...
            physical: section('Oxygen is often introduced as a colorless gas, but its physical chemistry becomes richer once liquid, solid, and magnetic behavior are considered.', [
            ...
            reactivity: section('Oxygen is one of the chemically defining oxidizing elements because it forms especially stable bonds to many metals and nonmetals.', [
            ...
            occurrence: section('Oxygen is abundant in both free and combined forms, but its distribution across the atmosphere, hydrosphere, and crust reflects very different chemical stories.', [
            ...
            isotopes: section('Oxygen isotopes are a powerful reminder that small mass differences can encode major information about environmental history.', [
            ...
            production: section('Oxygen production is a classic gas-separation problem whose scale is driven by metallurgical, medical, and chemical demand.', [
            ...
            applied: section('Oxygen is indispensable because it is both a biological necessity and an industrial oxidant of exceptional scale.', [
    ...
    },
    {
        ...
        oxidationStates: '-1',
        summaryLine: 'Fluorine is the most electronegative element and the most aggressive common elemental oxidant, giving it a chemistry dominated by strong fluoride bond formation and severe handling challenges.',
        importanceLine: 'Its chemistry reaches from mineral fluorides to nuclear fuel processing, advanced polymers, pharmaceuticals, and highly specialized industrial safety practice.',
        ...
        sections: {
            classification: section('Fluorine sits at the top of group 17, and its extreme electronegativity gives the halogen family a chemically meaningful upper limit.', [
            ...
            electronic: section('Fluorine needs only one electron to complete the octet, and that simple fact drives a remarkably forceful chemistry.', [
            ...
            physical: section('Fluorine is physically a pale yellow gas, but any physical description must immediately acknowledge that containment and chemistry are inseparable for this element.', [
            ...
            reactivity: section('Fluorine is the standard against which the reactivity of other elemental oxidants is often measured.', [
            ...
            occurrence: section('Fluorine is chemically too reactive to exist as F2 in nature, so all occurrence discussions center on fluoride minerals and dissolved fluoride.', [
            ...
            isotopes: section('Fluorine isotope chemistry is dominated by a single stable nuclide plus one radioisotope of enormous medical importance.', [
            ...
            production: section('Industrial fluorine manufacture is an electrochemical problem because fluoride is so stable that ordinary chemical oxidants are inadequate.', [
            ...
            applied: section('Fluorine chemistry matters because exceptionally strong fluoride bonds can create materials and processes that are hard to duplicate any other way.', [
    ...
    },
    {
        ...
        oxidationStates: '0',
        summaryLine: 'Neon is a noble gas with a filled second shell, famous for its emission colors and important as a model of inert atomic behavior in lighting, lasers, and gas-separation technology.',
        importanceLine: 'It links closed-shell electronic structure to spectroscopy, cryogenic separation, trace-atmosphere recovery, and the science of electrical discharge.',
        ...
        sections: {
            classification: section('Neon is classified as a noble gas because its filled second shell suppresses ordinary chemical reactivity and stabilizes the monatomic element.', [
            ...
            electronic: section('Neon is a clean example of a closed-shell atom whose electronic completeness leads to inert chemistry but vivid behavior under excitation.', [
            ...
            physical: section('Neon is physically a light monatomic gas, but its best-known property is not density or boiling point; it is luminous behavior in an electrical discharge.', [
            ...
            reactivity: section('Neon is among the least chemically reactive elements, so most practical discussion focuses on physical rather than synthetic chemistry.', [
            ...
            occurrence: section('Neon is present in the atmosphere only in trace amounts, so practical supply depends on processing very large volumes of air.', [
            ...
            isotopes: section('Neon isotopes are especially valuable in geochemistry and cosmochemistry because multiple stable nuclides record different source histories.', [
            ...
            production: section('Neon manufacture is a trace-gas separation problem built on very large air-processing infrastructure.', [
            ...
            applied: section('Neon is applied where stable inert gas behavior and distinctive emission characteristics are more important than chemical transformation.', [
    ...
    ...additionalElementSeeds_1.additionalChemistryElementSeeds,
    ...transitionElementSeeds_1.transitionElementSeeds,
    ...postZincElementSeeds_1.postZincElementSeeds,
    ...midPeriodicElementSeeds_1.midPeriodicElementSeeds,
    ...latePeriodFiveElementSeeds_1.latePeriodFiveElementSeeds,
    ...earlyPeriodSixElementSeeds_1.earlyPeriodSixElementSeeds,
    ...latePeriodSixElementSeeds_1.latePeriodSixElementSeeds,
    ...latePeriodSixHeavyElementSeeds_1.latePeriodSixHeavyElementSeeds,
    ...actinideElementSeeds_1.actinideElementSeeds,
    ...superheavyElementSeeds_1.superheavyElementSeeds,
];
