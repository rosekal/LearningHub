...
exports.biologyAccentSources = exports.biologyUnits = exports.biologyTopics = exports.biologySubject = void 0;
...
const topics = [
    {
        ...
        description: 'Core biological principles, characteristics of life, levels of organization, and scientific investigation in biology.',
        units: [
    ...
    },
    {
        id: 'cell-biology',
        title: 'Cell Biology',
        description: 'Cell structure, function, transport, signaling, and the organization of life at the cellular level.',
        units: [
            { title: 'Cell Theory' },
    ...
    },
    {
        ...
        description: 'The chemistry of life, biological macromolecules, enzymes, and cellular energy processes.',
        units: [
    ...
    },
    {
        ...
        description: 'Inheritance, gene expression, DNA structure, and the transmission of traits across generations.',
        units: [
    ...
    },
    {
        id: 'evolution',
        title: 'Evolution',
        description: 'Mechanisms of evolutionary change, common ancestry, adaptation, and the history of life.',
        units: [
    ...
    },
    {
        ...
        description: 'Classification of organisms and the major groups of life across bacteria, archaea, protists, fungi, plants, and animals.',
        units: [
    ...
    },
    {
        id: 'plant-biology',
        title: 'Plant Biology',
        description: 'Plant structure, transport, reproduction, and the biological processes that support plant life.',
        units: [
    ...
    },
    {
        ...
        description: 'Body systems, tissue organization, regulation, and how animals maintain homeostasis.',
        units: [
    ...
    },
    {
        id: 'ecology',
        title: 'Ecology',
        description: 'Interactions between organisms and environments, population dynamics, ecosystems, and energy flow.',
        units: [
    ...
    },
    {
        ...
        description: 'Human structure and function, disease, immunity, and biological foundations of health.',
        units: [
    ...
    },
    {
        id: 'biotechnology',
        title: 'Biotechnology',
        description: 'Modern biological techniques, genetic engineering, applied microbiology, and ethical issues in biological science.',
        units: [
...
const built = (0, createStructuredSubject_1.createStructuredSubject)({
    id: 'biology',
    title: 'Biology',
    description: 'Local-first biology content spanning cells, genetics, evolution, ecology, organismal systems, and biotechnology.',
...
exports.biologySubject = built.subject;
exports.biologyTopics = built.topics;
exports.biologyUnits = built.units;
exports.biologyAccentSources = built.accentSources;
