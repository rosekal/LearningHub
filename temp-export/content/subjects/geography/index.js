...
exports.geographyAccentSources = exports.geographyUnits = exports.geographyTopics = exports.geographySubject = void 0;
...
const topics = [
    {
        ...
        description: 'The basic concepts, tools, and perspectives used to study places, spaces, environments, and human activity.',
        units: [
    ...
    },
    {
        ...
        description: 'Mapmaking, geographic representation, GIS, remote sensing, and spatial analysis.',
        units: [
            { title: 'Types of Maps' },
    ...
    },
    {
        ...
        description: 'The atmosphere, hydrosphere, lithosphere, and biosphere as interacting components of the Earth system.',
        units: [
    ...
    },
    {
        ...
        description: 'Atmospheric processes, climate systems, and the distribution of weather patterns across Earth.',
        units: [
    ...
    },
    {
        ...
        description: 'The physical shaping of Earth’s surface through tectonics, erosion, rivers, glaciers, and coasts.',
        units: [
    ...
    },
    {
        ...
        description: 'The spatial distribution of living systems and the relationships between ecosystems and environment.',
        units: [
    ...
    },
    {
        ...
        description: 'Population patterns, migration, settlement, and demographic change across regions.',
        units: [
    ...
    },
    {
        ...
        description: 'Language, religion, identity, cultural landscapes, and the geographic expression of human societies.',
        units: [
    ...
    },
    {
        ...
        description: 'Territory, borders, states, geopolitics, and the spatial organization of political power.',
        units: [
    ...
    },
    {
        ...
        description: 'Production, trade, industry, development, and the spatial organization of economic systems.',
        units: [
    ...
    },
    {
        ...
        description: 'Cities, urban systems, land use, infrastructure, and the spatial form of urban environments.',
        units: [
    ...
    },
    {
        ...
        description: 'Human-environment interaction, resource use, environmental risk, and sustainability.',
        units: [
    ...
    },
    {
        ...
        description: 'Comparative study of world regions through physical, cultural, political, and economic patterns.',
        units: [
            { title: 'North America' },
            { title: 'Latin America' },
            { title: 'Europe' },
...
const built = (0, createStructuredSubject_1.createStructuredSubject)({
    id: 'geography',
    title: 'Geography',
    description: 'Local-first geography content spanning physical systems, human geography, regions, mapping, population, cities, and environmental change.',
...
exports.geographySubject = built.subject;
exports.geographyTopics = built.topics;
exports.geographyUnits = built.units;
exports.geographyAccentSources = built.accentSources;
