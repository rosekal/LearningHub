...
exports.getElementAccentPalette = getElementAccentPalette;
exports.getElementPaletteIds = getElementPaletteIds;
exports.getElementBackdropPalette = getElementBackdropPalette;
...
function mixHex(base, tint, ratio) {
...
function buildTonalBackdrop(theme, baseTone, divider) {
...
function aliasAccent(source, id, label) {
    return {
        ...source,
        id,
        label,
...
function registerAccentAliases(map) {
...
function resolveAccentId(unitId) {
    return subjects_1.subjectAccentSources[unitId] ?? unitId;
}
function getElementAccentPalette(unitId, theme) {
    if (!unitId) {
...
function getElementPaletteIds(mode) {
    const accentMap = mode === 'dark' ? darkAccents : lightAccents;
    return Object.keys(accentMap);
}
function getElementBackdropPalette(theme, accent) {
    if (!accent) {
        const baseTone = theme.mode === 'dark'
