...
const topics: StructuredTopicSeed[] = [
  {
    ...
    description:
      'Physical methods and principles used to study Earth’s structure, processes, and properties.',
  ...
  },
  {
    ...
    title: 'Seismology',
    description:
      'Earthquake waves, Earth structure, seismic methods, and the analysis of subsurface materials.',
    units: structuredUnits([
  ...
  },
  {
    ...
    description:
      'Earth’s gravity field, shape, geodetic measurement, and gravitational methods in Earth science.',
    units: structuredUnits([
      'Gravity Basics',
  ...
  },
  {
    ...
    title: 'Geomagnetism',
    description:
      "Earth's magnetic field, magnetic materials, and geophysical magnetic methods.",
    units: structuredUnits([
  ...
  },
  {
    ...
    description:
      "Earth's internal heat, mantle processes, and the physical basis of tectonic motion.",
    units: structuredUnits([
  ...
  },
  {
    ...
    description:
      'Subsurface investigation using electrical conductivity and electromagnetic response.',
    units: structuredUnits([
  ...
  },
  {
    ...
    description:
      'Geophysical methods used in natural resources, environmental work, engineering, and hazard analysis.',
    units: structuredUnits([
...
const built = createStructuredSubject({
  ...
  title: 'Geophysics',
  description:
    'Local-first geophysics content spanning seismic, gravity, magnetic, thermal, electrical, and applied Earth-physics methods.',
...
export const geophysicsSubject = built.subject;
export const geophysicsTopics = built.topics;
export const geophysicsUnits = built.units;
export const geophysicsAccentSources = built.accentSources;
