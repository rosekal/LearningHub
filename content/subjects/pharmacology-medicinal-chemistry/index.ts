...
const topics: StructuredTopicSeed[] = [
  {
    ...
    description:
      'Core principles of drugs, receptors, dose response, and the biological basis of pharmacological action.',
  ...
  },
  {
    ...
    description:
      'How drugs interact with targets and produce physiological effects.',
    units: structuredUnits([
  ...
  },
  {
    ...
    description:
      'Chemical principles underlying drug design, structure-activity relationships, and optimization of drug properties.',
    units: structuredUnits([
  ...
  },
  {
    ...
    description:
      'Target identification, screening, optimization, and translation from molecule to candidate drug.',
    units: structuredUnits([
  ...
  },
  {
    ...
    description:
      'Representative drug classes organized by major body systems and disease categories.',
    units: structuredUnits([
  ...
  },
  {
    ...
    description:
      'Toxic effects, safety assessment, and risk management in pharmacological practice and development.',
    units: structuredUnits([
...
const built = createStructuredSubject({
  ...
  description:
    'Local-first pharmacology and medicinal chemistry content spanning drug action, kinetics, design, therapeutics, and safety.',
...
export const pharmacologyMedicinalChemistrySubject = built.subject;
export const pharmacologyMedicinalChemistryTopics = built.topics;
export const pharmacologyMedicinalChemistryUnits = built.units;
export const pharmacologyMedicinalChemistryAccentSources = built.accentSources;
