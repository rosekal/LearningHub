...
const topics: StructuredTopicSeed[] = [
  {
    ...
    description:
      'Optimization, decision analysis, modeling, and the quantitative study of complex systems.',
  ...
  },
  {
    ...
    description:
      'Linear programming, feasible regions, duality, and resource allocation problems.',
    units: structuredUnits([
  ...
  },
  {
    ...
    description:
      'Discrete decision problems, network structures, and hard optimization tasks.',
    units: structuredUnits([
      'Integer Programming',
  ...
  },
  {
    ...
    description:
      'Uncertainty, random processes, queues, and simulation-based system analysis.',
    units: structuredUnits([
  ...
  },
  {
    ...
    description:
      'Decision-making under uncertainty, strategic interaction, and tradeoff analysis.',
    units: structuredUnits([
      'Decision Trees',
  ...
  },
  {
    ...
    description:
      'Feedback, delays, stock-flow structures, and dynamic behavior in complex systems.',
    units: structuredUnits([
      'Stocks and Flows',
      'Feedback Loops',
      'Delays in Systems',
  ...
  },
  {
    ...
    description:
      'Applications across logistics, health, infrastructure, environment, and strategic planning.',
    units: structuredUnits([
...
const built = createStructuredSubject({
  ...
  description:
    'Local-first operations research content spanning optimization, simulation, strategic decisions, and dynamic systems.',
...
export const operationsResearchSystemsScienceSubject = built.subject;
export const operationsResearchSystemsScienceTopics = built.topics;
export const operationsResearchSystemsScienceUnits = built.units;
export const operationsResearchSystemsScienceAccentSources = built.accentSources;
